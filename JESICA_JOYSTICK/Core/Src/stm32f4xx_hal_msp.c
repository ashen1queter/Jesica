...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PA7     ------> ADC1_IN7
    */
    HAL_GPIO_DeInit(GPIOA, JOYSTICK_THROTTLE_Pin|JOYSTICK_ROLL_Pin|JOYSTICK_YAW_Pin|JOYSTICK_PITCH_Pin);
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* htim_encoder)
{
  if(htim_encoder->Instance==TIM2)
  {
    ...
    PB3     ------> TIM2_CH2
    */
    HAL_GPIO_DeInit(WHEEL_B_GPIO_Port, WHEEL_B_Pin);

    HAL_GPIO_DeInit(WHEEL_A_GPIO_Port, WHEEL_A_Pin);
